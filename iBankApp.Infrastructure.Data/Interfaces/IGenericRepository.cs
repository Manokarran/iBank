...
namespace iBankApp.Interfaces.Data
{
    ...
    {        
        ...
        /// <returns>IQueryable TEntity</returns>
        IQueryable<TEntity> Get(Expression<Func<TEntity, bool>> expression, params Expression<Func<TEntity, object>>[] includes);
        ...
        /// <param name="includes">The includes.</param>
        /// <returns>IQueryable TEntity</returns>
        IQueryable<TEntity> GetReadOnly(Expression<Func<TEntity, bool>> expression, params Expression<Func<TEntity, object>>[] includes);
